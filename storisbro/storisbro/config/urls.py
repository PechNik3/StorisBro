...
from authentication.views import UserAPIView, ChangeProfileData, AllEmailUsersAPIView, UserOneAPIView, \
    BannedUserAPIView, VKAuthView, VKCallbackView
...
urlpatterns = [
    ...
    path('auth/vk/callback/', VKCallbackView.as_view(), name='vk_callback'),
    ...
    path('api/api_creatives/add_sticker_creative/<int:pk>', PK_StickerCreativeAPIView.as_view()),

    path('api/api_creatives/add_double_sticker_creative', DoubleStickerCreativeAPIView.as_view()),
    path('api/api_creatives/add_double_sticker_creative/<int:pk>', PK_DoubleStickerCreativeAPIView.as_view()),

    path('api/api_creatives/all_creatives/<str:filter_date>', AllCreativesAPIView.as_view()),
    path('api/api_creatives/all_creatives/<str:creative_type>/<int:pk>/', CreativeDetailAPIView.as_view(),
         name='creative_detail'),
    path('api/api_creatives/own_all_creatives/<int:first_name>', UserAllCreativesAPIView.as_view()),
    path('api/api_creatives/own_detail_creatives/<int:user>/<int:pk>', UserAllCreativesDetailAPIView.as_view()),
    path('api/api_creatives/detail_user_creative/<int:user>/<str:creative_type>/<int:pk>',
         UserCreativeDetailAPIView.as_view()),
    ...
    path('api/api_communities/own_communities/<int:first_name>', UserCommunityModelAPIView.as_view()),
    ...
    path('api/api_communities/communities/check/<int:pk>', UpdatePublicModelStatusAPIView.as_view()),
